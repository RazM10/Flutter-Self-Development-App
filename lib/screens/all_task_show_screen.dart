...
import 'package:flutter_self_development_app/utils/task_database.dart';
import 'package:intl/intl.dart';

import 'add_task_screen.dart';

class AllTaskShowScreen extends StatefulWidget {
  @override
  _AllTaskShowScreenState createState() => _AllTaskShowScreenState();
}

class _AllTaskShowScreenState extends State<AllTaskShowScreen> {
  ...
  _updateTaskList(){
    setState(() {
      _taskList = TaskDatabase.instance.getTaskList();
    });
  }
